...
async def build_value_manual_input_menu(ctx: MenuBuildContext[MenuContext]) -> MenuBuildingSpec:
    menu_spec = MenuSpec()
    menu_spec.body_text = I18nString('telegram-ui-basic-enter_new_page_number')
