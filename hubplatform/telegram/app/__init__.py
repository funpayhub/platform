...
from .goods_sources.router import goods_sources_router
from .goods_sources.builders import goods_sources_ui_registry


TELEGRAM_APP_ROUTER = Router(name='hubplatform.telegram_app')
TELEGRAM_APP_ROUTER.include_routers(
    props_router,
    goods_sources_router,
    ui_router,
)

TELEGRAM_APP_UI_REGISTRY = UIRegistry()
TELEGRAM_APP_UI_REGISTRY.merge_from(
    properties_ui_registry,
    expressions_ui_registry,
